...
CUDA_VISIBLE_DEVICES=0 python scripts/pretrain.py --gpus=1 --project=Circuit-PT --max_steps=50000 --gnn_ckpt=results/cgl/Circuit-PT/33c8jvqf/checkpoints/last.ckpt --run_name=gain_ft --path=configs/opamp/biased_pmos_gain/15-layer-ft-all-v1-0.1/config.py
