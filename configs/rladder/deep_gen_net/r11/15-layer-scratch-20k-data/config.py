...
dset = RLadderDataset(root='rdiv', train_fname='rdiv/rladder_r11_train_20k.pt', test_fname='rdiv/rladder_r11_test.pt')
...
exp_name = f'RLadder_R11_{fract}_scratch_20k_DeepGEN_h{hidden_channels}_nl{num_layers}_bs{train_batch_size}_lr{lr:.0e}_{activation}'
...
mdl_config = ParamDict(
    ...
    #            'warmup_updates': 0, 'tot_updates': 3000, 'end_lr': 1e-4},
    lr_warmup={'peak_lr': lr, 'weight_decay': 0, 
               'warmup_updates': 10, 'tot_updates': 300, 'end_lr': 1e-4},
    output_labels={'vdc': 1},
    proj_n_layers=3,
    output_sigmoid=['vdc'],
    # finetune=True,
