...
dset = RLadderDataset(root='rdiv', train_fname='rdiv/rladder_r11_train.pt', test_fname='rdiv/rladder_r11_test.pt')
...
exp_name = f'RLadder_R11_{fract}_ft_all_DeepGEN_h{hidden_channels}_nl{num_layers}_bs{train_batch_size}_lr{lr:.0e}_{activation}'
...
mdl_config = ParamDict(
    ...
    lr_warmup={'peak_lr': lr, 'weight_decay': 0, 
               'warmup_updates': 100, 'tot_updates': 1500, 'end_lr': 1e-5},
    output_labels={'vdc': 1},
    proj_n_layers=3,
    output_sigmoid=['vdc'],
    # finetune=True,
