...
dset = RLadderDataset(root='rdiv', train_fname='rladder_r16_train_20k.pt', test_fname='rladder_r16_test.pt')
...
exp_name = f'RLadder_DeepGEN_scratch_r16_h{hidden_channels}_nl{num_layers}_bs{train_batch_size}_lr{lr:.0e}_{activation}'
