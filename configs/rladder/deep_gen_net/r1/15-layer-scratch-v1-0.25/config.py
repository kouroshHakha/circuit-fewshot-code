...
dset = RLadderDataset(root='rdiv', train_fname='rdiv/rladder_r1_train.pt', test_fname='rdiv/rladder_r1_test.pt')
...
exp_name = f'RLadder_R1_{fract}_scratch_DeepGEN_h{hidden_channels}_nl{num_layers}_bs{train_batch_size}_lr{lr:.0e}_{activation}'
...
mdl_config = ParamDict(
    ...
    #            'warmup_updates': 100, 'tot_updates': 300, 'end_lr': 1e-4},
    output_labels={'vdc': 1},
    proj_n_layers=3,
    output_sigmoid=['vdc'],
    finetune=True,
    stepLR=[100, 200, 300, 400]
)
