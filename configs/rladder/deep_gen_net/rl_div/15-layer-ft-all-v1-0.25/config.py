...
dset = RLadderDataset(root='rdiv', train_fname='rl_div_train.pt', test_fname='rl_div_test.pt')
...
exp_name = f'RLDIV_{fract}_ft_all_DeepGEN_h{hidden_channels}_nl{num_layers}_bs{train_batch_size}_lr{lr:.0e}_{activation}'
