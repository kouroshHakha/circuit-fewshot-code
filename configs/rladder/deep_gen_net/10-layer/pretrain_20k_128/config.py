...
dset = RLadderDataset(root='rdiv', train_fname='rladder_r128_train_20k.pt', test_fname='rladder_r128_test.pt')
...
hidden_channels = 128
num_layers = 10
train_batch_size = min(32, len(train_dset))
valid_batch_size = min(32, len(valid_dset)) 
test_batch_size = min(32, len(test_dset)) 


exp_name = f'RLadder_DeepGEN_scratch_r128_h{hidden_channels}_nl{num_layers}_bs{train_batch_size}_lr{lr:.0e}_{activation}'
