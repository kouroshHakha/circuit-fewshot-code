...
hidden_channels = 128
num_layers = 10
train_batch_size = min(128, len(train_dset))
valid_batch_size = min(128, len(valid_dset)) 
test_batch_size = min(128, len(test_dset)) 


exp_name = f'RLadder_DeepGEN_scratch_r32_h{hidden_channels}_nl{num_layers}_bs{train_batch_size}_lr{lr:.0e}_{activation}'
