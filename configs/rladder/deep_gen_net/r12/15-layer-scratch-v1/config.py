...
dset = RLadderDataset(root='rdiv', train_fname='rladder_r12_train.pt', test_fname='rladder_r12_test.pt')
...
exp_name = f'RLadder_R12_{fract}_scratch_DeepGEN_h{hidden_channels}_nl{num_layers}_bs{train_batch_size}_lr{lr:.0e}_{activation}'
