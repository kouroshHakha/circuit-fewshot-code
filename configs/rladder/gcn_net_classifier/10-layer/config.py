...
from cgl.models.gnn_classifier import GCNNetClassifer
...
exp_name = f'RLadder_GCNNet_classifier_h{hidden_channels}_nl{num_layers}_bs{train_batch_size}_lr{lr:.0e}_{activation}'
...
model = GCNNetClassifer(mdl_config).to(sample_data.x.dtype)
